<?php 
	...
	/**
	 * [文件上传函数]
	 * @param  string $field     [表单中name值 默认为myfile]
	 * @param  string $maxSize   [允许上传的最大值 默认10M]
	 * @param  array  $allowType [允许上传的主类型 默认image text]
	 * @param  string $path      [默认的保存根目录 默认./uploads/]
